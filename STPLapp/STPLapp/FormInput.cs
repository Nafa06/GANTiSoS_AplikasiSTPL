...
namespace STPLapp
{
    public partial class FormInput : Form
    {
        ...
        private void FormInput_Load(object sender, EventArgs e)
        {
            ...
            txtNrp.Text = nrpPetugas;
            txtNrpNemu.Text = nrpPetugas;
        ...
        private void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                FormMenu formMenu = new FormMenu(nrpPetugas);
                formMenu.Show();
                this.Hide();
            }
            catch (Exception ex)
        ...
        private void btnSimpanNemu_Click(object sender, EventArgs e)
        {
            ...
            if (txtNikPenemu.Text.Length != 16 || !txtNikPenemu.Text.All(char.IsDigit))
            {
                MessageBox.Show("NIK harus terdiri dari 16 digit angka.", "Input Tidak Valid", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
